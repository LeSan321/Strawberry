  ...
  return <div className="min-h-screen">
      ...
      <section className="text-center py-20 px-4 relative overflow-hidden">
        ...
        duration: 0.8
          ...
          <span className="bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent block leading-tight" style={{
        ...
        delay: 0.2
          ...
          fontFamily: "Poppins",
          fontWeight: "400"
        }}>Music made by us. Not markets</div>
          <div style={{
          fontFamily: "Poppins",
          fontWeight: "400"
        }}>No judgement. No algorithms.</div>
          <div style={{
          fontFamily: "Poppins",
          fontWeight: "400"
        }}>Just heartbeat-driven sound.</div>
        </motion.h2>
        
        {/* Animated Graffiti Tagline */}
        <motion.div className="relative inline-block mb-12" onHoverStart={() => setHoveredGraffiti(true)} onHoverEnd={() => setHoveredGraffiti(false)}>
          ...
          duration: 0.8,
          delay: 0.4
        }}>Share Your Vibe. Build Your Tibe. </motion.p>
          
          <motion.div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-black text-white px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap" initial={{
          opacity: 0,
          scale: 0.8,
          rotate: -5
        }} animate={{
    ...
    Join the Tribe
      ...
      <section className="py-16 px-4 bg-white/50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          duration: 0.6,
          delay: 0.2
        }}>From the first rough memo to a stadium-ready mix, every tool here serves one purpose: helping you be heard.</motion.p>
